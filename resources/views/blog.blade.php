<x-layout>
    ...
    <div class="w-11/12 mx-auto px-6 py-12">
        <h1 class="text-4xl font-extrabold text-blue-600 mb-4 text-center">
            {{ $title }}
        </h1>
        <div class="px-4 mx-auto max-w-screen-xl lg:px-6 mb-8">
        ...
        <div class="grid gap-8 md:grid-cols-2 mb-10">
            @forelse ($post as $item)
                <article
                    ...
                    <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{{ Str::limit($item['body'], 200) }}
                    </p>
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-4">
                            ...
                            <a href="/blog?author={{ $item->author->name }}" class="font-medium dark:text-white">
                                {{ $item->author->name }}
                            </a>
                        </div>
                ...
                @empty
                <div>
                    <h1 class="font-bold text-9xl">Article Not Found!!</h1>
                    <a href="/blog" class="text-blue-600 mt-8 block">&laquo; Back To All Posts</a>
                </div>
            @endforelse
        </div>
        {{ $post->links() }}
